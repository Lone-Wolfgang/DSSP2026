...
from DSSP2026.linear_regression.fit import fit_ols, predict_ols, _fill_missing_predictors
from DSSP2026.linear_regression import plots as rplots
from DSSP2026.linear_regression import tables as rtables
...
def fit_and_plot_ols(df, formula, *, alpha=0.05, plot_kind="auto",
    ...
    table  : pandas Styler
    """
    from DSSP2026.linear_regression.fit import resolve_plot_kind
