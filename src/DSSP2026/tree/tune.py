...
def tune_rf_grid(
    ...
    *,
    ...
    """Cross-validated grid search for a RandomForestRegressor.

    Returns a GridSearchResult holding the refit best estimator, the chosen
    params, and the raw cv_results_ dict (for the heatmap in tree/plots.py).
    """
    ...
    grid = GridSearchCV(base_rf, param_grid, cv=kf, scoring=scoring,
